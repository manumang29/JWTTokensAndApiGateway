package com.javatechie.sringsecurity.service;

import com.javatechie.sringsecurity.dto.Product;
import com.javatechie.sringsecurity.entity.UserInfo;
import com.javatechie.sringsecurity.repo.UserInfoRepository;
...
public class ProductService {
    ...
    public void loadProductsFromDB(){
        productList = IntStream.rangeClosed(1,100).mapToObj(i->Product.builder().productId(i)
                .name("product " + i)
